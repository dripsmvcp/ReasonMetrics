...
interface ShareBarProps {
  ...
  /** The model that produced this trace, when the source knows it (live
   * mode). Exports are named after it in preference to the trace id, which
   * for a live trace is just an autogenerated placeholder. */
  model?: string;
...
export function ShareBar({
  ...
  const filename = (ext: string) =>
    exportFilename({ model, id: trace.id }, result.composite).replace(/\.png$/, ext);
